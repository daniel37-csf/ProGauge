...
const LIBRARY_NODES: GameNode[] = [
  {
    ...
    action: "Play",
    specs: [
      { label: 'Engine', value: 'VULKAN_X' },
      { label: 'Latency', value: '8ms' },
      { label: 'Build', value: 'v4.2.1-STABLE' }
    ],
    description: 'High-speed tactical infiltration. Master the neon-lit corridors and bypass global security grids.',
    developer: 'CYBER_CORE_SYST',
    publisher: 'VOID_IND',
    releaseDate: 'OCT 2025',
    genre: 'TACTICAL_STEALTH',
    platforms: ['WIN_X', 'LINUX_V', 'DECK_OS'],
    fullSynopsis: 'In a world where data is the only currency, you are a ghost in the machine. Neon Protocol takes you through a series of high-stakes infiltration missions across the Tokyo Spires. Use advanced decryption nodes and physical agility to navigate levels that react to your presence in real-time.',
    steamMetadata: {
      userReview: 'OVERWHELMINGLY_POSITIVE',
      criticScore: 94,
  ...
  },
  {
    ...
    action: "Install",
    specs: [
      { label: 'Engine', value: 'NEUTRON_DRIVE' },
      { label: 'Physics', value: 'PHYSX_UNBOUND' },
      { label: 'Build', value: 'v1.0.4-BETA' }
    ],
    description: 'The fastest anti-gravity racing simulation. Break the sound barrier across modular tracks.',
    developer: 'ALT_VECTOR_LABS',
    publisher: 'SPEED_SYNC',
    releaseDate: 'JAN 2026',
    genre: 'RACING_SIM',
    platforms: ['WIN_X', 'CONSOLE_H'],
  ...
  },
  {
    ...
    action: "Play",
    specs: [
      { label: 'AI Core', value: 'STRATA_MIND' },
      { label: 'Lighting', value: 'RTX_ULTRALIGHT' },
      { label: 'Build', value: 'v2.8.9-PRO' }
    ],
    description: 'Isometric tactical stealth. Command a group of elite operatives through highly secured sectors.',
    developer: 'MIND_SYNC_SOC',
    publisher: 'STRATA_GLOBAL',
    releaseDate: 'MAR 2025',
    genre: 'TACTICAL_RPG',
    platforms: ['WIN_X', 'MACOS_X', 'LINUX_V'],
          ...
          >
            ...
            <section className="space-y-12">
              ...
              <div className="flex flex-wrap gap-4 scrollbar-hide">
                <FilterChip label="All Nodes" active />
                <FilterChip label="Local_Cache" />
                <FilterChip label="Priority_Links" />
                <FilterChip label="Recent_Sync" />
              </div>
            </section>
          ...
          >
            ...
            <div className="p-6 border-b border-white/10 flex justify-between items-center bg-black/40 sticky top-0 z-10 backdrop-blur-md">
              ...
              >
                ...
                <span>Return_To_Inventory</span>
              </button>
              <div className="flex items-center gap-4">
                 <div className="hidden sm:flex items-center gap-4 border-r border-white/10 pr-4 mr-4">
                    <Activity className="w-4 h-4 text-primary" />
                    <span className="text-[10px] font-mono text-white/40 uppercase tracking-[0.2em] italic">Session_Active: {selectedNode?.hours}</span>
                 </div>
                 <Shield className="w-4 h-4 text-primary animate-pulse" />
                 <span className="text-[10px] font-mono text-white/20 uppercase tracking-[0.5em]">Secure_Link_Established</span>
                ...
                <div className="lg:col-span-7 p-12 lg:p-16 flex flex-col justify-between bg-black/20">
                  <div className="space-y-16">
                     ...
                     <div className="grid grid-cols-2 md:grid-cols-4 gap-x-12 gap-y-8 border-b border-white/5 pb-12">
                        ...
                        <MetadataItem label="Release_Date" value={selectedNode?.releaseDate} />
                        ...
                        {selectedNode?.steamMetadata && (
                          <>
                            <MetadataItem label="User_Rating" value={selectedNode.steamMetadata.userReview} color="text-primary" />
                            <MetadataItem label="Critic_Score" value={selectedNode.steamMetadata.criticScore.toString()} color="text-primary" />
                          </>
                        )}
                     </div>
                     ...
                     <div className="space-y-6">
                        <div className="flex items-center gap-3">
                           ...
                           <h4 className="text-[11px] font-bold uppercase tracking-[0.3em] italic text-white/60">Node_Briefing_Log</h4>
                        </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 mt-20">
                     <button className="flex-[2] py-6 bg-white text-black font-black uppercase tracking-[0.4em] text-[12px] hover:bg-primary transition-all flex items-center justify-center gap-4 relative overflow-hidden group">
                        ...
                        <span>{selectedNode?.action === 'Play' ? 'Initialize_Node' : 'Begin_Deployment'}</span>
                     </button>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 border-b border-white/10 bg-black/40">
                <div className="lg:col-span-8 p-12 lg:p-16 border-b lg:border-b-0 lg:border-r border-white/10">
                   <div className="flex items-center justify-between mb-12">
                      <div className="flex items-center gap-4">
                         ...
                         <h3 className="text-2xl font-black uppercase tracking-widest italic">System_Requirements</h3>
                      </div>
                      <span className="text-[10px] font-mono text-white/20 uppercase tracking-[0.4em]">Hardware_Verification: PASS</span>
                   </div>

                   <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                      <div className="space-y-8">
                         <h4 className="text-[10px] font-bold uppercase tracking-widest text-primary italic">Minimum_Load_Profile</h4>
                         <div className="space-y-6">
                      ...
                      <div className="space-y-8">
                         <h4 className="text-[10px] font-bold uppercase tracking-widest text-primary italic">Recommended_Load_Profile</h4>
                         <div className="space-y-6">
                ...
                <div className="lg:col-span-4 p-12 lg:p-16 flex flex-col">
                   <div className="flex items-center gap-4 mb-12">
                      ...
                      <h3 className="text-[11px] font-bold uppercase tracking-[0.3em] italic text-white/60">Related_Nodes</h3>
                   </div>
                   ...
                   <div className="mt-12 p-8 border border-white/5 bg-white/[0.02] flex flex-col items-center justify-center gap-4 grayscale opacity-40 hover:opacity-100 hover:grayscale-0 transition-all cursor-pointer">
                      ...
                      <span className="text-[10px] font-black uppercase tracking-[0.3em]">Explore_Global_Net</span>
                   </div>
                </div>
              </div>
            </div>
    ...
    >
      ...
      <div className="flex-grow flex flex-col gap-4">
        ...
        <div className="flex flex-wrap gap-8 text-[9px] font-mono uppercase tracking-[0.2em] text-white/60">
          <div className="flex items-center gap-2 italic"><Clock className="w-3 h-3" /> {hours} DATA</div>
          <div className="flex items-center gap-2"><RefreshCw className="w-3 h-3" /> {lastPlayed}</div>
          {status && <div className="text-primary border border-primary/20 bg-primary/5 px-2">SYST_STAT: {status}</div>}
        </div>
      </div>
